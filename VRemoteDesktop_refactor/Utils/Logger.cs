...
namespace Vsign4.VRemoteDesktop.Utils
{
    internal class Logger
    {
        ...
        public class Logging
        {
            ...
            public void Info(string message, string message1)
            {
                Write("INFO", string.Format("{0} {1}", message, message1));
            }
            public void Warning(string message, string message1)
            {
                Write("WARN", string.Format("{0} {1}", message, message1));
            }
            public void Error(string message, string message1)
            {
                Write("ERROR", string.Format("{0} {1}", message, message1));
            }
            public void Fatal(string message, string message1)
            {
                Write("FATAL", string.Format("{0} {1}", message, message1));
            }
