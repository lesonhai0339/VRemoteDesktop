...
namespace VRemoteServer.RelayServer.Helpers
{
    public static class DefaultValue
    {
        ...
        {
            public static int TIMEOUT = 600; //Unit: second
            public static int SCHEDULE_TIME = 30;
            public static int PACKET_HEADER_LENGTH = 13;
            // Upper bound for a single packet's declared size. Guards the framing loop against
            // a corrupt/malicious length field (negative or huge) that would otherwise hang.
            public static int MAX_PACKET_SIZE = 64 * 1024 * 1024;
