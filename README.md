...
Allows connection between two computers, even across different networks.
...
Keyboard Control: Send keyboard events from the controller to the controlled machine.

Mouse Control: Send mouse actions from the controller to the controlled machine.
