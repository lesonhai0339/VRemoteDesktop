...
namespace VRemoteDesktop.Services.RemoteDesktop
{
    public partial class RemoteService : IDisposable
    {
        ...
        public RemoteService(IVScreenSender screenSender, SessionManager sessionManager, IMachineProfile machineProfile)
        {
            Initialize();
        ...
        private void Initialize()
        {
            _eventHandlers = new Dictionary<SocketDataType, Action<object, EventArgs>>
            {
                ...
                { SocketDataType.ScreenOk, FullScreenSendCompleted}
            };
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                {
                    _keyboardService.KeyPressed -= KeyboardEventHandler;
                }
